...
The objective is how to load the compartments of the vehicle so that the replenishment time is maximized. We can linearize the Max-Min problem to a Max problem with an additional constrain:
\begin{flalign}
max \ \ \ t
\end{flalign}
subject to
