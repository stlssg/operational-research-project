...
\begin{itemize}
\item In order to maximize the replenishment time, we need to load products as much as possible to not only satisfy but also exceed the demands and thus, have less diliveries. It implies that we can find a feasible solution which try to fill up all the compartments.
